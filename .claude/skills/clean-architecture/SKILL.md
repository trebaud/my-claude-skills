...
- **When custom code IS justified:**
  - Specific business logic unique to the business area
...
- **Clean Architecture & Business-Focused Principles:**
  ...
  - Define features clearly and keep them isolated
- **Naming Conventions:**
  - **AVOID** generic names: `utils`, `helpers`, `common`, `shared`
  - **USE** business-specific names: `OrderCalculator`, `UserAuthenticator`, `InvoiceGenerator`
  - Follow feature area naming patterns
